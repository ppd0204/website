...
<ul>
    <li><a href="examples/Leaflet-integration.html">Leaflet integration</a> - Show how it works with layer control and attribution</li>
	<li><a href="examples/OpenLayers-integration.html">OpenLayers integration</a> - Show how it works with layer control and attribution</li>
    ...
    <li><a href="examples/GeoJSON-set.html">GeoJSON set</a> - Put custom GeoJSON on the map</li>
</ul>
...
<ul>
    <li><a href="http://osmbuildings.org/darkside/">Building shadows</a> - These shadows are date and time dependent, according to sun position</li>
    <li><a href="http://osmbuildings.org/anaglyph3d/">Anaglyph 3D mode</a> - Put your 3D glasses on! It requires more than 3x rendering effort - slow!</li>
